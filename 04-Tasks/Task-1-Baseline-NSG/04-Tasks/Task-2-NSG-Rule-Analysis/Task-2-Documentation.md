...
To analyse the existing Network Security Group rules and identify the opportunity to replace individually defined access rules with Application Security Group (ASG)-based rules.
